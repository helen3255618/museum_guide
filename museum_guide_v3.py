    ...
    VERSIONS = [
        {
            ...
            "changes": [
                ...
                "🔍 Model upgraded to gpt-4o for image understanding",
...
# ── Session state ────────────────────────────────────────────
for k, v in [("history", []), ("display", []), ("pending_image", None)]:
...
with col1:
    ...
    if camera_shot:
        ...
        st.success("Photo ready — now record your question")
...
if audio_input:
    ...
    if user_text:
        # Show visitor message (with photo indicator if image attached)
        ...
        user_msg = build_user_message(user_text, st.session_state.pending_image)
