    ...
    VERSIONS = [
        {
            ...
            "changes": [
                ...
                "💰 Smart model routing: gpt-4o-mini for text, gpt-4o only when photo attached",
...
if audio_input:
    ...
    if user_text:
        # Prepend specimen name to user message if set
        full_text = user_text
        if st.session_state.specimen_name:
        ...
        # Clear pending image after sending (name stays locked)
        st.session_state.pending_image = None
