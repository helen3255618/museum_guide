    ...
    VERSIONS = [
        {
            ...
            "date": "2026-03-24",
            "changes": [
                "📌 Input bar truly fixed at bottom using st.container + CSS targeting",
...
st.markdown('<div class="conversation-pad">', unsafe_allow_html=True)
...
# ── Sticky input bar ──────────────────────────────────────────
with st.container(key="bottom_input"):
