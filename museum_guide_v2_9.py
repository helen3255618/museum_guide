    ...
    VERSIONS = [
        {
            ...
            "date": "2026-03-23",
            "changes": [
                "🚀 Migrated to Responses API — using gpt-5.4-mini",
                "📝 No bullet points — conversational response style enforced in system prompt",
                ...
                "📷 Camera removed (Responses API text-only for stability)",
            ],
        },
        {
            "version": "v2.0",
...
SYSTEM_PROMPT = (
    ...
    "Do not use bullet points or lists. All responses must be conversational prose."
)
